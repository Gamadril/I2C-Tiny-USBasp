...
#ifdef	USBTINY_USB_TX_LED
		CLR(USBTINY_USB_TX_LED); // LED on
#endif
		usb_out( data, rx_len );
#ifdef	USBTINY_USB_TX_LED
		SET(USBTINY_USB_TX_LED); // LED off
#endif
	}
#endif
	usb_tx_total  = limit;
...
extern	void	usb_poll ( void )
{
	...
	{	// SE0 for more than 2.5uS is a reset
		...
		usb_address = 0;
#ifdef	USBTINY_USB_OK_LED
		SET(USBTINY_USB_OK_LED);	// LED off
#endif
	}
}
